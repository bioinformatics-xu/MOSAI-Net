...
class Mulit_Graph_model:
    def __init__(self, pet_features, pathology_features,
                 pet_adj, pathology_adj,
        ...
        self.multimodal_gcn = Multi_GNN_model(
            pet_num_features=pet_features.size(1),pathology_num_features=pathology_features.size(1),
            num_classes=labels.max().item() + 1,
            pet_edge_index=pet_adj,pathology_edge_index=pathology_adj,
            pet_x=pet_features,pathology_x=pathology_features,
    ...
    def training(self):
        ...
        for epoch in range(self.args.nb_epochs):
            ...
            logits,self.fused_features, self.fused_adj = self.multimodal_gcn(
                self.pet_features, self.pathology_features,
