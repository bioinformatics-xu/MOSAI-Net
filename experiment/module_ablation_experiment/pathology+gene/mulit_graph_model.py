...
class Mulit_Graph_model:
    def __init__(self, pathology_features, gene_features,
                 pathology_adj,gene_adj,
        ...
        self.multimodal_gcn = Multi_GNN_model(
            pathology_num_features=pathology_features.size(1),gene_num_features=gene_features.size(1),
            num_classes=labels.max().item() + 1,
            pathology_edge_index=pathology_adj,gene_edge_index=gene_adj,
            pathology_x=pathology_features,gene_x=gene_features,
    ...
    def training(self):
        ...
        for epoch in range(self.args.nb_epochs):
            ...
            logits,self.fused_features, self.fused_adj = self.multimodal_gcn(
                self.pathology_features, self.gene_features,
                self.pathology_adj, self.gene_adj)
