...
class Mulit_Graph_model:
    def __init__(self, gene_features, extra_features,
                 gene_adj,extra_adj,
        ...
        self.multimodal_gcn = Multi_GNN_model(
            gene_num_features=gene_features.size(1),extra_num_features=extra_features.size(1),
            num_classes=labels.max().item() + 1,
            gene_edge_index=gene_adj,extra_edge_index=extra_adj,
            gene_x=gene_features,extra_x=extra_features,
    ...
    def training(self):
        ...
        for epoch in range(self.args.nb_epochs):
            ...
            if epoch % 5 == 0 and epoch != 0:
                ...
                _,fused_features_eval, fused_adj_eval = self.multimodal_gcn(
                                                                             self.gene_features,self.extra_features,
                                                                             self.gene_adj, self.extra_adj)
