...
class Multi_GNN_model(nn.Module):
    def __init__(self, pathology_num_features,
                 num_classes, pathology_edge_index,
                 pathology_x, args):
    ...
    def forward(self, pathology_x, pathology_edge_index):
        ...
        x_f = self.bottleneck(pathology_x_gcn)
        # 对每个节点进行分类
        ...
        return logits, pathology_log, x_f, pathology_edge_index
