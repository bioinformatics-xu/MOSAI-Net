...
class Multi_GNN_model(nn.Module):
    def __init__(self, gene_num_features,
                 num_classes, gene_edge_index,
                 gene_x, args):
    ...
    def forward(self, gene_x, gene_edge_index):
        ...
        x_f = self.bottleneck(gene_x_gcn)
        # 对每个节点进行分类
        ...
        return logits, gene_log, x_f, gene_edge_index
