...
class Multi_GNN_model(nn.Module):
    def __init__(self, pet_num_features,
                 num_classes, pet_edge_index,
                 pet_x, args):
    ...
    def forward(self, pet_x, pet_edge_index):
        ...
        return logits, pet_log, x_f, pet_edge_index
